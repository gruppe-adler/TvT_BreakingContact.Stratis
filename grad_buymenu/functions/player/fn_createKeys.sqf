...
_ctrlPriceKey =  _display ctrlCreate ["RscStructuredText", _idc];     _ctrlPriceKey ctrlSetPosition [_xPos, safeZoneH/20*9, safeZoneW/20, safeZoneH/10];     _ctrlPriceKey ctrlSetBackgroundColor [0,0,0,0];     _ctrlPriceKey ctrlSetStructuredText parseText ("<t color='#c0c0c0'  shadow='0' align='left'>Price</t>");     _ctrlPriceKey ctrlSetTextColor [1,1,1,0.5];
