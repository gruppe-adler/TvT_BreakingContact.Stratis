...
{     style = "0x400 + 0x10";     type = 43;  // this is the more "modern" slider. Type = 3 is the old dull one.     shadow = 0;     color[] = {1,1,1,0.4};     colorActive[] = {1,1,1,1};     colorDisabled[] = {0.5,0.5,0.5,0.2};     arrowEmpty = "\A3\ui_f\data\gui\cfg\slider\arrowEmpty_ca.paa";     arrowFull = "\A3\ui_f\data\gui\cfg\slider\arrowFull_ca.paa";     border = "\A3\ui_f\data\gui\cfg\slider\border_ca.paa";     thumb = "\A3\ui_f\data\gui\cfg\slider\thumb_ca.paa";
};

class BC_buymenu_RscStructuredText
{
    access = 0;     idc = -1;     type =  CT_STRUCTURED_TEXT;     style = ST_MULTI;
    lineSpacing = 0.5;     colorBackground[] = {-1,-1,-1,0};     colorText[] = {1,1,1,0.7};     size = 0.038;     text = "";     fixedWidth = 0;     x = 0;     y = 0;     h = 0;     w = 0;
    shadow = 0;
};
...
{
    access = 0;     idc = -1;     type =  CT_STRUCTURED_TEXT;     style = ST_CENTER;     colorBackground[] = {-1,-1,-1,0};     colorText[] = {0.5,0.5,0.5,1};     size = 0.048;     text = "";     fixedWidth = 0;     x = 0;     y = 0;     h = 0;     w = 0;     shadow = 0;     font = "puristaMedium";
};
