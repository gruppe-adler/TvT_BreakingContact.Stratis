...
refreshRussianUI = {
	...
	_display displayCtrl 1401 ctrlSetStructuredText parsetext _name;
	_display displayCtrl 1402 ctrlSetStructuredText parsetext _price;
	_display displayCtrl 1403 ctrlSetStructuredText parsetext _count;
