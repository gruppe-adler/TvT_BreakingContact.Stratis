...
if (_vehicleType == "RDS_Ikarus_Civ_01" || _vehicleType == "RDS_Ikarus_Civ_02") exitWith {
     ...
     for [{_i=0}, {_i<_crewCount}, {_i=_i+1}] do {     	[_group,_veh] call GRAD_civs_fnc_createVehicleCargo;     };     [_veh,_group]
};


if (_crewCount > 0) then {     for [{_i=0}, {_i<_crewCount}, {_i=_i+1}] do {     	[_group,_veh] call GRAD_civs_fnc_createVehicleCargo;     };
};
