...
if (side _unit == east) then {
    ...
    {side _player == east && _target getVariable ["BC_hasAntenna", false]}] call ace_interact_menu_fnc_createAction;
...
if (side _unit == east) then {
    ...
    {side _player == west && _target getVariable ["BC_hasAntenna", false]}] call ace_interact_menu_fnc_createAction;
