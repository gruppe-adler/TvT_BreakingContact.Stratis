...
private _startPosition = _startPosition;
private _conePosition = _conePosition;
...
private _mrk_cone = createMarkerLocal [format["markerCone_%1", toString _conePosition], _conePosition];
