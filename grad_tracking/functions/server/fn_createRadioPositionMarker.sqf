...
{     if (_x distance _center < GRAD_MIN_DISTANCE_TO_RADIOPOSITION) then {     	_anotherCloseBy = true;     };
...
if (isMultiplayer) then {     [_center] call GRAD_tracking_fnc_createRadioPositionMarkerLocal;
};
