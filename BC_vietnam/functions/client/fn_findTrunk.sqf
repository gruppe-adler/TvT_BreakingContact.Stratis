...
if (isNil "BC_vietnam_trunkOffsetsCache") then {BC_vietnam_trunkOffsetsCache = call CBA_fnc_createNamespace};
private _modelName = ((str _tree) splitString " .") select 1;
private _offset = BC_vietnam_trunkOffsetsCache getVariable [_modelName,[]];
...
BC_vietnam_trunkOffsetsCache setVariable [_modelName,_offset];
