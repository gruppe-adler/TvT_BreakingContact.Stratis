...
_function = {
    ...
    drawIcon3D [getText (configFile >> "CfgVehicles" >> (typeOf _vehicle) >> "icon", [1,1,1,1], (getPosATL _vehicle) vectorAdd [0,0,1], 1, 1, 45, format ["%1 (%2m)", _displayName, round (player distance _vehicle)], 1, 0.04, "PuristaMedium", "center", true];
};
