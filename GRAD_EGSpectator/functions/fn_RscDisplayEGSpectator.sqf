...
switch _mode do
{
	...
	case "onLoad":
	{
		scriptName "GRAD_RscDisplayEGSpectator: onLoad";
		...
		{
			scriptName "GRAD_RscDisplayEGSpectator: Loop";
			disableSerialization;
		...
		if !(missionNamespace getVariable [VAR_ALLOW_FREE_CAMERA, true]) then
		{
			...
			{
				"GRAD_RscDisplayEGSpectator: Unable to assign initial focus and free camera is disabled" call BIS_fnc_error;
			};
		};
	...
	case "onUnload":
	{
		scriptName "GRAD_RscDisplayEGSpectator: onUnload";
	...
	{
		scriptName "GRAD_RscDisplayEGSpectator: Update_GameTime";
	...
	{
		scriptName "GRAD_RscDisplayEGSpectator: Update_PlayerList";
	...
	{
		scriptName "GRAD_RscDisplayEGSpectator: Update_LocationList";
	...
	{
		scriptName "GRAD_RscDisplayEGSpectator: ToggleUiVisibility";
	...
	{
		scriptName "GRAD_RscDisplayEGSpectator: GetAllDisplayControls";
	...
	case "KeyDown":
	{
		scriptName "GRAD_RscDisplayEGSpectator: KeyDown";
		disableSerialization;
	...
	case "KeyUp":
	{
		scriptName "GRAD_RscDisplayEGSpectator: KeyUp";
		disableSerialization;
	...
	case "OnMapClicked" :
	{
		scriptName "GRAD_RscDisplayEGSpectator: OnMapClicked";
	...
	{
		scriptName "GRAD_RscDisplayEGSpectator: MouseButtonDown";
		disableSerialization;
	...
	case "MouseButtonUp" :
	{
		scriptName "GRAD_RscDisplayEGSpectator: MouseButtonUp";
		disableSerialization;
	...
	{
		scriptName "GRAD_RscDisplayEGSpectator: MouseButtonDblClick";
		disableSerialization;
	...
	case "ChildDestroyed":
	{
		scriptName "GRAD_RscDisplayEGSpectator: ChildDestroyed";
		disableSerialization;
	...
	{
		disableSerialization;
		scriptName "GRAD_RscDisplayEGSpectator: FlashSideTaskThread";
	...
	default
	{
		scriptName "GRAD_RscDisplayEGSpectator: Default";
